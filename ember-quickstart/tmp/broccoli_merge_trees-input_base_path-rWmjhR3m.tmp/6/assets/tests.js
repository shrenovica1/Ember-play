...
define('ember-quickstart/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/page-header.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/page-header.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/singin.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/singin.js should pass ESLint\n\n24:10 - \'error\' is defined but never used. (no-unused-vars)');
  });
  ...
  QUnit.test('routes/restaurant.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/restaurant.js should pass ESLint\n\n');
  });
...
define('ember-quickstart/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('integration/components/page-header-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/page-header-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/singin-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/singin-test.js should pass ESLint\n\n');
  });
